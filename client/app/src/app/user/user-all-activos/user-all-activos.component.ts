...
@Component({
  selector: 'app-user-all-activos',
  templateUrl: './user-all-activos.component.html',
  styleUrls: ['./user-all-activos.component.css']
})
export class UserAllActivosComponent implements AfterViewInit{
  ...
  ngAfterViewInit(): void {
    //console.log("datos " + this.datosOriginales);
    this.listarUsuarios();
  }
  listarUsuarios(){
    this.gService
...
/*         this.uOriginal.Deshabilitado = true;
        console.log("en teoría, debería ya cambiarse el campo Deshabilitado ", this.uOriginal);
 */
